...
vlog -work ./work ../netlist/FIR_unfolded.v
vlog -work ./work ./tb_fir.v
#vsim -L /software/dk/nangate45/verilog/msim6.2g
vsim -L /software/dk/nangate45/verilog/msim6.2g -sdftyp /tb_fir/UUT=../netlist/FIR_unfolded.sdf work.tb_fir
#vcd file ../vcd/FIR_unfolded_syn_quarter_fm.vcd
#vcd add /tb_fir/UUT/*
#run 0.8 us
#vcd2saif -input ../vcd/FIR_unfolded_syn_quarter_fm.vcd -output ../saif/FIR_unfolded_syn_quarter_fm.saif
