...
fp1=fopen('C:\Users\asus\Desktop\Term3\Integrated systems architecture\LABS\LAB1\samples.txt','w');
fprintf(fp1,'%d\n', xq);
fclose(fp1);

fp=fopen('C:\Users\asus\Desktop\Term3\Integrated systems architecture\LABS\LAB1\resultsm.txt', 'w');
fprintf(fp, '%d\n', yq);
fclose(fp);
